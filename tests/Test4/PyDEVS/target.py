...
class MainAppInstance(RuntimeClassBase):
    ...
    def _state1_enter(self):
        self.big_step.outputEvent(Event("output_event", self.getOutPortName("ui"), [str('%.2f' % (self.getSimulatedTime() / 1000.0))]))
    
    def _state1_0_exec(self, parameters):
        self.big_step.outputEvent(Event("received", self.getOutPortName("ui"), [str('%.2f' % (self.getSimulatedTime() / 1000.0))]))
