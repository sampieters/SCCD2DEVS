...
Model description:
Test 12: Check if an instance broadcast properly
"""
...
class MainAppInstance(RuntimeClassBase):
    ...
    def _state4_enter(self):
        self.big_step.outputEventOM(Event("broad_cast", None, [self, Event("test_broad", None, [])]))
...
class AInstance(RuntimeClassBase):
    ...
    def build_statechart_structure(self):
        ...
        _state1_0.setAction(self._state1_0_exec)
        _state1_0.setTrigger(Event("test_broad", None))
        self.states["/state1"].addTransition(_state1_0)
    
    def _state1_0_exec(self, parameters):
        self.big_step.outputEvent(Event("broadcast_received", self.getOutPortName("ui"), []))
