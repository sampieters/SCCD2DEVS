...
Test 3.9: Try to delete an instance from a class that is not the creator of that instance
        Note: This should work because the instance is now associated
"""
...
class MainAppInstance(RuntimeClassBase):
    ...
    def build_statechart_structure(self):
        ...
        self.states["/state6"].setEnter(self._state6_enter)
    ...
    def _state6_enter(self):
        self.big_step.outputEventOM(Event("narrow_cast", None, [self, 'linkA[0]', Event("remove", None, [])]))
